    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'spu_id', type: 'bigint', isNullable: true },
          ...
          { name: 'currency_id', type: 'bigint', isNullable: true },
          { name: 'currency_code', type: 'varchar', length: '20', isNullable: true },
          { name: 'quantity', type: 'int', default: 0 },
          { name: 'purchaser_id', type: 'bigint', isNullable: true },
          ...
          { name: 'unit_id', type: 'bigint', isNullable: true },

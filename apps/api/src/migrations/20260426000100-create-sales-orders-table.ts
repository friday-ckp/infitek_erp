    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'after_sales_source_order_id', type: 'bigint', isNullable: true },
          ...
          { name: 'destination_country_id', type: 'bigint', isNullable: true },
          ...
          { name: 'shipment_origin_country_id', type: 'bigint', isNullable: true },
          { name: 'shipment_origin_country_name', type: 'varchar', length: '100', isNullable: true },
          { name: 'signing_company_id', type: 'bigint', isNullable: true },
          { name: 'signing_company_name', type: 'varchar', length: '200', isNullable: true },
          { name: 'salesperson_id', type: 'bigint', isNullable: true },
          ...
          { name: 'destination_port_id', type: 'bigint', isNullable: true },
          ...
          { name: 'extra_viewer_id', type: 'bigint', isNullable: true },
          ...
          { name: 'merchandiser_id', type: 'bigint', isNullable: true },
          ...
          { name: 'shipper_other_info_company_id', type: 'bigint', isNullable: true },

      ...
      <ProForm
        ...
        onFinish={async (values) => {
          ...
          const payload: CreateProductDocumentPayload = {
            ...
            categoryLevel1Id: values.attributionType === 'category_l1' && values.categoryLevel1Id ? Number(values.categoryLevel1Id) : undefined,
            categoryLevel2Id: values.attributionType === 'category_l2' && values.categoryLevel2Id ? Number(values.categoryLevel2Id) : undefined,
            categoryLevel3Id: values.attributionType === 'category_l3' && values.categoryLevel3Id ? Number(values.categoryLevel3Id) : undefined,
            spuId: values.attributionType === 'product' && values.spuId ? Number(values.spuId) : undefined,
            fileKey,
            fileName,
          };

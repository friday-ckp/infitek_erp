...
export default function SupplierFormPage() {
  ...
  const basicTab = (
    <div className="master-form-body">
      ...
      <ProForm.Group>
        <ProFormText name="contactPerson" label="联系人" width="sm" placeholder="请输入联系人" />
        <ProFormText name="contactPhone" label="联系电话" width="sm" placeholder="请输入联系电话" />
        <ProFormText
          name="contactEmail"
          label="联系邮箱"
          width="md"
      ...
      <ProForm.Group>
        ...
        />
        <ProFormText name="origin" label="货源地" width="md" placeholder="请输入货源地" />
        <ProFormText name="supplierLevel" label="供应商等级" width="sm" placeholder="请输入供应商等级" />
      </ProForm.Group>
      <ProFormTextArea
        name="address"
        label="公司详细地址"
  ...
  const tabItems: TabsProps['items'] = [
    ...
    { key: 'business', label: '商务条件', children: businessTab },
    { key: 'paymentTerms', label: '账期信息', children: paymentTermsTab },
  ];
    ...
    <div className="master-page master-form-page">
      <Breadcrumb
        items={[
          ...
          { title: isEdit ? `编辑 ${detailQuery.data?.name ?? ''}` : '新建供应商' },
        ]}
      />
        ...
        onFinish={async (values) => {
          const normalizedPaymentTerms = ((values.paymentTerms ?? []) as Array<Record<string, unknown>>).map(
            (item) => ({
              ...
              settlementType: item.settlementType as SupplierSettlementType | undefined,
              ...
              settlementDateType: item.settlementDateType as SupplierSettlementDateType | undefined,
            }),
          );
